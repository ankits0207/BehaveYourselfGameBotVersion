<%@ Page Title="" Language="C#" MasterPageFile="~/BehaveYourself.Master" AutoEventWireup="true" CodeBehind="Instructions2.aspx.cs" Inherits="BehaveYourself.WebForm3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MyContentPlaceholder" runat="server">
    <table style="width: 100%;">
        <tr>
            <td class="auto-style7"><strong>Instructions 2/3<br />
        ...
        <tr>
            <td class="auto-style8" colspan="2">
                <asp:Image ID="Image1" runat="server" ImageUrl="~/Refresh1.jpg" />
            </td>
        </tr>
    </table>
</asp:Content>
